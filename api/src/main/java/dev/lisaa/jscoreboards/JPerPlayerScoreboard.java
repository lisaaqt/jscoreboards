...
public class JPerPlayerScoreboard extends JScoreboard {
  ...
  private Function<Player, Component> generateTitleFunction;
   ...
   * This will not change in between updates, but will change if the player is removed and re-added to the dev.lisaa.jscoreboards.JScoreboard.
